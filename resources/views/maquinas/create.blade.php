...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Agregar Máquina</h1>
        <p class="mt-2 text-sm text-gray-600">Registra una nueva máquina en el sistema</p>
    </div>

    <!-- Form -->
    <div class="bg-white shadow-sm rounded-lg">
        <form action="{{ route('maquinas.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" id="costo_bn_carilla" name="costo_bn_carilla" step="0.01" min="0" value="{{ old('costo_bn_carilla') }}" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500">
                ...
                <div>
                    ...
                    <input type="number" id="costo_color_carilla" name="costo_color_carilla" step="0.01" min="0" value="{{ old('costo_color_carilla') }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500">
            ...
            <div>
                <label class="flex items-center">
                    <input type="checkbox" id="activa" name="activa" value="1" {{ old('activa', true) ? 'checked' : '' }}
